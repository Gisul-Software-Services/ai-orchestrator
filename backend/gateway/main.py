...
_ORG_GATED_POST_PATHS = frozenset(
    {
        ...
        "/api/v1/evaluation/sql",
        "/api/v1/evaluation/sql/async",
        "/api/v1/evaluation/devops",
        "/api/v1/evaluation/devops/async",
        "/api/v1/evaluation/cloud",
        "/api/v1/evaluation/cloud/async",
        "/api/v1/evaluation/dsa",
        "/api/v1/evaluation/dsa/async",
        "/api/v1/evaluation/aiml",
